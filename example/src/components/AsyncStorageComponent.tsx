  ...
  return (
    <View style={styles.container}>
      <Text style={styles.item}>
        <Text style={styles.strong}>[READ|650kb]</Text> AsyncStorage:&nbsp;
        {timeExpensive.toFixed(2)} ms
      </Text>
      <Text style={styles.item}>
        <Text style={styles.strong}>[READ|15kb]</Text> AsyncStorage:&nbsp;
        {timeCheap.toFixed(2)} ms
      </Text>
      <Text style={styles.item}>
        <Text style={styles.strong}>[WRITE|650kb]</Text> AsyncStorage:&nbsp;
